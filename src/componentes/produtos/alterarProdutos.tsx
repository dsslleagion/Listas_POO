...
export default class AlterarProduto extends Component<any, props> {
        ...
        return (
            <div>
                ...
                <div className='container center'>
                    <h4> <strong>Atualizar Produto </strong> </h4>
                </div>
                <div className='container center'>
                    <div className="row">
                        <form className="col s12">
                            <div className="row">
                                ...
                                <Link to='/listaProdutos'>
                                    <button className="waves-effect waves-light btn red lighten-2" type="submit" name="action">Atualizar Produto
